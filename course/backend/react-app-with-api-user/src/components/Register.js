					...
					<div className="row">
						<div className="col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
							<form className="form-signin" onSubmit={(e) => { e.preventDefault(); this.handlerSubmit() }}>
								...
								<input type="text" id="inputName" className="form-control mb-4" placeholder="Name of user" required autoFocus onChange={e => this.fillInput(e.target)}/>

								<label htmlFor="inputSurname" className="sr-only">Surname</label>
								<input type="text" id="inputSurname" className="form-control mb-4" placeholder="Surname of user" required onChange={e => this.fillInput(e.target)} />

								<label htmlFor="inputEmail" className="sr-only">Email address</label>
								<input type="email" id="inputEmail" className="form-control mb-4" placeholder="Email address" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}" required onChange={e => this.fillInput(e.target)} />

								<div className="form-group">
									<label htmlFor="inputUsername" className="sr-only">Username</label>
									<input type="text" id="inputUsername" className="form-control" placeholder="Username" required pattern="^[a-zA-Z0-9]{6,18}$" onChange={e => this.fillInput(e.target)} />
								...
								<div className="form-group">
									...
									<input type="password" id="inputPassword" className="form-control" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required onChange={e => this.fillInput(e.target)} />
